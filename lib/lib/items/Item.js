...
var Item = exports["default"] = /*#__PURE__*/function (_Component) {
  function Item(_props) {
    ...
    _defineProperty(_this, "onMouseMove", function (e) {
      ...
      if (Number(divRect.left) + Number((e === null || e === void 0 ? void 0 : (_e$currentTarget = e.currentTarget) === null || _e$currentTarget === void 0 ? void 0 : _e$currentTarget.clientWidth) || 0) < e.clientX) {
    ...
    _defineProperty(_this, "getItemProps", function () {
      var _this$props, _this$props$item;
      var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      //TODO: maybe shouldnt include all of these classes
      var classNames = 'rct-item' + (_this.props.item.className ? " ".concat(_this.props.item.className) : '') + ' rct_draggable_' + ((_this$props = _this.props) === null || _this$props === void 0 ? void 0 : (_this$props$item = _this$props.item) === null || _this$props$item === void 0 ? void 0 : _this$props$item.group);
      return {
        key: _this.itemId,
  ...
  return _createClass(Item, [{
    ...
    value: function mountInteract() {
      ...
      (0, _interactjs["default"])(this.item).resizable({
        ...
        if (_this2.props.selected) {
          var _e$rect;
          if (Number(e === null || e === void 0 ? void 0 : (_e$rect = e.rect) === null || _e$rect === void 0 ? void 0 : _e$rect.left) + Number(e === null || e === void 0 ? void 0 : e.target.clientWidth) < Number(e === null || e === void 0 ? void 0 : e.pageX)) {
            return false;
          }
    ...
    value: function render() {
      var _this$props4, _this$props4$group, _this$props5, _this$props5$group;
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, !((_this$props4 = this.props) !== null && _this$props4 !== void 0 && (_this$props4$group = _this$props4.group) !== null && _this$props4$group !== void 0 && _this$props4$group.isHide) || (_this$props5 = this.props) !== null && _this$props5 !== void 0 && (_this$props5$group = _this$props5.group) !== null && _this$props5$group !== void 0 && _this$props5$group.isMerge ? this.props.itemRenderer({
